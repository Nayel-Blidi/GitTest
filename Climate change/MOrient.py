...
lon_mo_min, lon_mo_max = 100, 300
lat_mo_min, lat_mo_max = 180, 300
...
plt.title("tp \n"+time[0])
plt.suptitle('MOrient_1979')
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_1979')
...
plt.title("tp \n"+time[-1])
plt.suptitle('MOrient_2019')
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_2019')

#%% Plot anomaly variation every year
plt.close('all')
...
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_t2m_anomaly_evo')
...
for k in range(40):
    ...
    plt.title(time[k*12], fontsize=8)
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_r_anomaly_evo')
...
for k in range(40):
    ...
    plt.title(time[k*12], fontsize=8)
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_swvl1_anomaly_evo')
...
for k in range(40):
    ...
    plt.title(time[k*12], fontsize=8)
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_tp_anomaly_evo')
...
plt.suptitle("Land means evolutions : Middle East", fontsize=14)
plt.subplot(2, 2, 1)
...
plt.title("tp_mean")
plt.xticks(rotation=60)
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_land_means_evo')

fig, ax = plt.subplots(2, 2, figsize=(10, 10))
fig.subplots_adjust(hspace=0.4)
for axi in ax.flat:
    axi.xaxis.set_major_locator(plt.MaxNLocator(20))
plt.suptitle("Land anomalies evolutions : Middle East", fontsize=14)
plt.subplot(2, 2, 1)
...
plt.xticks(rotation=60)
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/MOrient_land_anomalies_evo')
