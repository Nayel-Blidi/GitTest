...
lon_mo_min, lon_mo_max = 900, 1100
lat_mo_min, lat_mo_max = 150, 350
...
plt.title("tp \n"+time[0])
plt.suptitle('WCoast_1979')
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_1979')
...
plt.title("tp \n"+time[-1])
plt.suptitle('WCoast_2019')
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_2019')
...
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_t2m_anomaly_evo')
...
for k in range(40):
    ...
    plt.axis('off')
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_r_anomaly_evo')
...
for k in range(40):
    ...
    plt.axis('off')
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_swvl1_anomaly_evo')
...
for k in range(40):
    ...
    plt.axis('off')
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_tp_anomaly_evo')
...
plt.suptitle("Land means evolutions : West Coast")
plt.subplot(2, 2, 1)
...
plt.title("tp_mean")
plt.xticks(rotation=60)
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_land_means_evo')

fig, ax = plt.subplots(2, 2, figsize=(10, 10))
fig.subplots_adjust(hspace=0.4)
for axi in ax.flat:
    axi.xaxis.set_major_locator(plt.MaxNLocator(20))
plt.suptitle("Land anomalies evolutions : West Coast")
plt.subplot(2, 2, 1)
...
plt.xticks(rotation=60)
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/WCoast_land_anomalies_evo')
