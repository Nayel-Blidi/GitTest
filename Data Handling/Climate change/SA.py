...
lon_mo_min, lon_mo_max = 0, 220
lat_mo_min, lat_mo_max = 300, 530
...
plt.title("tp \n"+time[0])
plt.suptitle('SA_1979')
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_1979')
...
plt.title("tp \n"+time[-1])
plt.suptitle('SA_2019')
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_2019')
...
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_t2m_anomaly_evo')
...
for k in range(40):
    ...
    plt.axis('off')
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_r_anomaly_evo')

fig, ax = plt.subplots(4, 10)
plt.suptitle("Yearly swvl1 mean anomaly \n [-0.05 m3.m-3, +0.05 m3.m-3]")
for k in range(40):
    plt.subplot(4, 10,k+1)
    plt.imshow(array_anomaly[2, k*12:(k+1)*12, :, :].mean('time'), vmin=-0.05, vmax=0.05)
    plt.title(time[k*12], fontsize=8)
    plt.axis('off')
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_swvl1_anomaly_evo')
...
for k in range(40):
    ...
    plt.axis('off')
plt.get_current_fig_manager().full_screen_toggle()
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_tp_anomaly_evo')
...
plt.suptitle("Land means evolutions : South Africa", fontsize=14)
plt.subplot(2, 2, 1)
...
plt.title("tp_mean")
plt.xticks(rotation=60)
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_land_means_evo')

fig, ax = plt.subplots(2, 2, figsize=(10, 10))
fig.subplots_adjust(hspace=0.4)
for axi in ax.flat:
    axi.xaxis.set_major_locator(plt.MaxNLocator(20))
plt.suptitle("Land anomalies evolutions : South Africa", fontsize=14)
plt.subplot(2, 2, 1)
...
plt.xticks(rotation=60)
plt.savefig('C:/Travail/IPSA/Aero4/Module électif/GRAPHS_PNG_PLOTS_ECV/SA_land_anomalies_evo')
